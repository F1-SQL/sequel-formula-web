  ...
  return (
    <Layout title="A SQL Server Formula 1 Database" style={{ position: 'relative' }}>
      ...
      <div class={`${classes.main} ${classes.container}`}>
        ...
        <p class={classes.heroText}>
          To get started with the database in your own instance of Microsoft SQL Server, simply download the data using the link below
          and follow along using the documentation to get setup.
        </p>
        <div>
          <Button to="/docs/welcome">
            Read The Documentation 
          </Button>
          <Button primary to="/docs/getting-started/">
            Download The Data
          </Button>
        </div> 
